...
@threestudio.register("flame-tetrahedra")
class TetrahedraSDFGrid(BaseExplicitGeometry):
    ...
    def isosurface(self) -> Mesh:
        ...
        if self.cfg.fix_geometry and self.mesh is not None:
            return self.mesh
        mesh = self.isosurface_helper(self.sdf, self.deformation, self.cfg.stage, init_stage=True)
        mesh.v = scale_tensor(
            mesh.v, self.isosurface_helper.points_range, self.isosurface_bbox
        )
