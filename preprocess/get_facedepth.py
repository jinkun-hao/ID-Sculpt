...
base_model_path = "../../../sd_model/models--xanderhuang--depth-adapted-sd1.5/snapshots/4f8cdfc5b0c531520fdbb88df33e7e609c14a402"
...
def main(id, caption, root_dir):
    ...
    images = ip_model.generate(
        prompt=prompt + 'black background, depth map, head only', negative_prompt=None, faceid_embeds=faceid_embeds,
        #   image=[laion_img.resize(canny_image.size), canny_image],
        image=canny_image, scale=0.1,
    ...
    grid.save(os.path.join(root_dir, id, 'img_depth.png'))
